...
import { h2a, run, requireDependencies } from './runtime.mjs';

export async function buildByoSync({ frontend = true } = {}) {
  requireDependencies();
...
if (process.argv[1] === fileURLToPath(import.meta.url)) await buildByoSync();
